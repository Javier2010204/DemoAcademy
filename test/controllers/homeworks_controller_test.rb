...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post homeworks_url, params: { homework: { classroom_id: @homework.classroom_id, delivery_date: @homework.delivery_date, description: @homework.description, title: @homework.title, user_id: @homework.user_id } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { classroom_id: @homework.classroom_id, delivery_date: @homework.delivery_date, description: @homework.description, title: @homework.title, user_id: @homework.user_id } }
